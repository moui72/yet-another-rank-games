...
const CATAN_THING: BggThing = {
	...
	playingTime: 120, thumbnailUrl: 'x.jpg', imageUrl: 'x-full.jpg', mechanics: ['Trading'], categories: ['Economic'], isExpansion: false
};
const CARC_THING: BggThing = {
	bggId: 822, name: 'Carcassonne', yearPublished: 2000, weight: 1.9, minPlayers: 2, maxPlayers: 5,
	playingTime: 45, thumbnailUrl: 'y.jpg', imageUrl: 'y-full.jpg', mechanics: ['Tile Placement'], categories: ['Medieval'], isExpansion: false
};
