...
Why: the pool builder can currently only add catalogue games (those already imported by some collection); BGG search closes the gap of adding arbitrary games. Needs the BGG API token.
